...
let up = `🚀 *_DENU-X-MD Connected Successfully!_* ✅ 

--- *🧚‍♀️🎉 _Welcome to DENU-X-MD!_* 🎉🧚‍♀️ 
...
_Thank you for using_ *🧚‍♀️DENU-X-MD💗.*
_We're here to make your experience enjoyable and seamless._
_If you need any help or have questions, don't hesitate to ask._ 🌝💗

_*🧚‍♀️Enjoy your time with us!😊*_

*ᴅᴇɴᴜ x ᴍᴅ ʙʏ ᴍʀ ᴅᴇɴᴜᴡᴀɴッ*`;

conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://i.ibb.co/gZ0c8QYC/3263.jpg` }, caption: up })
...
conn.sendFileUrl = async (jid, url, caption, quoted, options = {}) => {
              let mime = '';              let res = await axios.head(url)
